---
name: cmd-retro
description: "RETRO phase — delegate to harness-improver to mine failures from logs and candidate wiki nodes, curate the wiki ACE-style, and propose bounded harness edits for user approval (mirrors /harness:retro)"
---
