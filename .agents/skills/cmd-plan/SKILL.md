---
name: cmd-plan
description: "PLAN + DESIGN phases — planner writes prd.md, architect (plus product-designer for user-facing work) writes design.md, 코디네이터 breaks it into plan.md tasks; ends at a user approval gate before build (mirrors /harness:plan)"
---
